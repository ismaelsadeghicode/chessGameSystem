...
import com.util.Listener;
import com.util.VoicePlayback;
import com.util.VoiceRecorder;
import com.util.VoiceUtil;
...
public class ChatController implements Initializable {
    ...
    public void setImageLabel() throws IOException {
        this.userImageView.setImage(new Image(getClass().getClassLoader().getResource("images/esmaeil.png").toString()));
    }
    ...
    public void newUserNotification(Message msg) {
        Platform.runLater(() -> {
            ...
            tray.setMessage(msg.getName() + " has joined the chess Chatroom!");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        borderPane.setOnMousePressed(event -> {
            xOffset = ClientApp.getPrimaryStage().getX() - event.getScreenX();
            yOffset = ClientApp.getPrimaryStage().getY() - event.getScreenY();
            borderPane.setCursor(Cursor.CLOSED_HAND);
        });

        borderPane.setOnMouseDragged(event -> {
            ClientApp.getPrimaryStage().setX(event.getScreenX() + xOffset);
            ClientApp.getPrimaryStage().setY(event.getScreenY() + yOffset);
    ...
    public void setImageLabel(String selectedPicture) {
        switch (selectedPicture) {
            case "esmaeil":
                ...
                break;
            case "amir":
                this.userImageView.setImage(new Image(getClass().getClassLoader().getResource("images/amir.png").toString()));
                break;
            case "Default":
